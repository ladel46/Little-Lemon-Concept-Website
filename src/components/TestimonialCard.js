...
export default function TestimonialCard(props) {
  return (
    ...
    <div className=" bg-Swhite from-Lyellow relative to-Lgreen border-[1px] flex flex-col flex-wrap border-black w-[300px]  drop-shadow-2xl  rounded-lg h-[275px] px-[48px] py-[20px]  ">
